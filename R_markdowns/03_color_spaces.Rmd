---
title: "Explore HCL colors interactively in R"
...
Manually pick three colors for a qualitative color scale. Use **hue-chroma**
plane to use colors with same luminance (i.e., perceived the same by human eye).
